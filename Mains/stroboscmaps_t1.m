...
for epsilon = [0.81 0.85 0.86 0.90 0.93 0.95 0.96 1]
	...
	for theta = [0 0.5 1]
		...
		[T, Y] = odeIntegSeason(ICRef, TFinal, TRecord, @(t, y) seasonKill2Sp_Type1(t, y, false), options);
...
legend('Location', 'northeast', 'Labels', {'\theta = 0', '\theta = 0.5', '\theta = 1'}, 'FontSize', 6);
savefig('../Outputs/fig_stroboscmaps_t1.fig');
print('../Figures/fig_stroboscmaps_t1', '-dpng');
