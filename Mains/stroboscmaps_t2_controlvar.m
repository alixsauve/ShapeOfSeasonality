...
for epsilon = [0.3 0.36 0.38 0.41 0.44 0.47 0.48 0.5]
	...
	for theta = [0 0.5 1]
		...
		[T, Y] = odeIntegSeason(ICRef, TFinal, TRecord, @(t, y) seasonKill2Sp_Type2(t, y, true), options);
...
savefig('../Outputs/fig_stroboscmaps_t2_controlvar.fig');
print('../Figures/fig_stroboscmaps_t2_controlvar', '-dpng');
